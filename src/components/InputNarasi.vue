    ...
    <div class="modal-container-confirm">
      <div class="row">
        <div class="col-md-5 col-sm-7">
          <h3 class="title-modals mb-3">Tugas Narasi</h3>
        </div>
        <div class="col-md-7 col-sm-5" style="text-align: right">
      ...
      <form action="">
        <input
          type="text"
          class="in-link"
          placeholder="Masukan Link Penugasan..."
          v-model="linkNarasi"
        />
      ...
      <div class="d-flex bb">
        <button class="btn btn-back" @click="submitNarasi">Kirim</button>
      </div>
    </div>
  </div>
</template>
    ...
    submitNarasi() {
      ...
      axios({
        ...
        .then((res) => {
          console.log(res);
          // this.closeModal();
          window.location.href = `${import.meta.env.VITE_FE_BASE_URL}/profile`;
        })
        .catch(() => {
          // this.closeModal();
          Swal.fire({
