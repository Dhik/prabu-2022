          ...
          <div class="row">
            <div class="col-md-3 ml-auto mr-auto bg-prof-name">
              <div class="profile">
                ...
                <div class="name">
                  ...
                  <h4 class="nama-siswa" style="text-transform: uppercase">
                    {{ fakultas }}
                  </h4>
                  <br />
            ...
            <div class="col-md-9 ml-auto mr-auto">
              ...
              <article class="postcard dark">
                ...
                <div class="postcard__text">
                  ...
                  <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 hide_min_576"></div>
                    <div class="col-md-4 col-sm-12">
                      ...
                      <span
                        v-if="
                          ...
                          resultBagaskaraBud.is_active == true
                        "
                      >
                        <p class="stat-">0/1</p>
                        <router-link
                  ...
                  <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 col-sm-12">
                      <span
                        v-if="
                          (resultPradia.grade == '' ||
                            resultPradia.grade == null) &&
                          resultPradia.is_active == true
                        "
                      >
                        <p class="stat-">0/1</p>
                  ...
                  <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 col-sm-12">
                      <span
                        v-if="
                          resultNarasi.grade == '' ||
                          resultNarasi.grade == null ||
                          resultNarasi.is_active == true
                        "
                      >
                        <p class="stat-">0/1</p>
                ...
                <div class="postcard__text">
                  ...
                  <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 col-sm-12">
                      <span
                        v-if="
                          (resultPostTest.answer == '' ||
                            resultPostTest.answer == null) &&
                          resultPostTest.is_active == true
                        "
                      >
                        <p class="stat-">0/1</p>
                        <router-link
                          to="/postTest-dd57b80806af85b312e13581f48b95c7"
                          class="btn btn-primer5"
                          >Kerjakan Kuis</router-link
                        ></span
                      >
              ...
              <button
                ...
                "
              >
                <router-link to="/sertif"> Sertifikat </router-link>
              </button>
            </div>
          </div>
          <!-- <div class="row">
    ...
    getUserProfile() {
      ...
      axios({
        ...
        .then((res) => {
          ...
          this.fakultas = res.data.faculty;
          this.resultBagaskaraBud = res.data.assignment.bagaskara_budaya;
          this.resultBagaskaraUnp = res.data.assignment.bagaskara_unpad;
          // this.resultBagaskaraBudGrade = this.resultBagaskaraBud.grade;
          // this.resultBagaskaraUnpGrade = this.resultBagaskaraUnpGrade.grade;
          ...
          // console.log(this.resultPostTest);
